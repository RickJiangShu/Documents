...
# 算法难点
* 不同于“颜料桶”填充算法，在二维格子的条件下，会产生多个封闭区域。如下图  
![output-1](https://github.com/RickJiangShu/Documents/blob/master/TrackFillAlgorithm/output-1.jpg "output-1")


解决方案：通过横线/竖线检测，对多个区域进行填充。

* 确定“线”，两点成一线，竖线连竖线/横线连横线，但是遇到拐角如何处理？如下图1.2


解决方案：  
我定义了一个“线点”的概念，根据规律找出
...
# 设计思路
1、逐列进行“横向检测”，将框线两条竖线之间的格子标记为1，如下图1.2;
2、逐行进行“纵向检测”，将框线两条横线之间的格子标记为1,

3、遍历找寻种子，并进行种子填充，将种子标记为2，如下图1.3；
